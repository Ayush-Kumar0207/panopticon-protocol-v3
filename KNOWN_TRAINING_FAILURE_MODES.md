...
| S02 | Canonical BF16 is fixed. Before expert generation, a real one-step LoRA forward/backward/optimizer probe rejects unsupported precision, OOM, non-finite/zero loss, or non-finite/zero gradients. |
